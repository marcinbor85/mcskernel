...
${OBJECTDIR}/src/main.o: src/main.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Isrc/mcs -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.c

${OBJECTDIR}/src/mcs/mcsService.o: src/mcs/mcsService.c 
	${MKDIR} -p ${OBJECTDIR}/src/mcs
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Isrc/mcs -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mcs/mcsService.o src/mcs/mcsService.c

${OBJECTDIR}/src/mcs/port/linux/mcsPort.o: src/mcs/port/linux/mcsPort.c 
	${MKDIR} -p ${OBJECTDIR}/src/mcs/port/linux
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Isrc/mcs -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mcs/port/linux/mcsPort.o src/mcs/port/linux/mcsPort.c
